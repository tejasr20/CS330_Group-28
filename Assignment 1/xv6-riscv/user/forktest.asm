...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <pinfo+0xe>
  ...
  68:	40c50513          	addi	a0,a0,1036 # 470 <pinfo+0x1e>
  ...
  b8:	40c50513          	addi	a0,a0,1036 # 4c0 <pinfo+0x6e>
  ...
  d4:	3c050513          	addi	a0,a0,960 # 490 <pinfo+0x3e>
  ...
  ee:	3be50513          	addi	a0,a0,958 # 4a8 <pinfo+0x56>
