...
forktest(void)
{
  ...
  3e:	40650513          	addi	a0,a0,1030 # 440 <getppid+0xc>
  ...
  68:	3ec50513          	addi	a0,a0,1004 # 450 <getppid+0x1c>
  ...
  b8:	3ec50513          	addi	a0,a0,1004 # 4a0 <getppid+0x6c>
  ...
  d4:	3a050513          	addi	a0,a0,928 # 470 <getppid+0x3c>
  ...
  ee:	39e50513          	addi	a0,a0,926 # 488 <getppid+0x54>
