...
int main()
{
  ...
  1a:	81a58593          	addi	a1,a1,-2022 # 830 <malloc+0xe6>
  1e:	4505                	li	a0,1
  20:	00000097          	auipc	ra,0x0
  24:	63e080e7          	jalr	1598(ra) # 65e <fprintf>
  ...
  4c:	80858593          	addi	a1,a1,-2040 # 850 <malloc+0x106>
  50:	4505                	li	a0,1
  ...
  7e:	7fe58593          	addi	a1,a1,2046 # 878 <malloc+0x12e>
  82:	4505                	li	a0,1
  84:	00000097          	auipc	ra,0x0
  88:	5da080e7          	jalr	1498(ra) # 65e <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	4b050513          	addi	a0,a0,1200 # 8a8 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 608:	29c90913          	addi	s2,s2,668 # 8a0 <malloc+0x156>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d0:	1f47b783          	ld	a5,500(a5) # 8c0 <freep>
...
malloc(uint nbytes)
{
 ...
 7d4:	0ea73823          	sd	a0,240(a4) # 8c0 <freep>
      return (void*)(p + 1);
