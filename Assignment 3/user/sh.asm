...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3dc70713          	addi	a4,a4,988 # 14a0 <malloc+0x1f6>
    ...
    panic("runcmd");
      ...
      e2:	2ca50513          	addi	a0,a0,714 # 13a8 <malloc+0xfe>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	2b058593          	addi	a1,a1,688 # 13b0 <malloc+0x106>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	0b4080e7          	jalr	180(ra) # 11be <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	27458593          	addi	a1,a1,628 # 13c0 <malloc+0x116>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	068080e7          	jalr	104(ra) # 11be <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	1ee50513          	addi	a0,a0,494 # 13d0 <malloc+0x126>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	026080e7          	jalr	38(ra) # 12aa <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	fdc080e7          	jalr	-36(ra) # 12aa <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f82080e7          	jalr	-126(ra) # 12aa <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	f3c080e7          	jalr	-196(ra) # 12aa <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	efa080e7          	jalr	-262(ra) # 12aa <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	0fe98993          	addi	s3,s3,254 # 14f8 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	09a98993          	addi	s3,s3,154 # 14f8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	03098993          	addi	s3,s3,48 # 14f8 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	020a8a93          	addi	s5,s5,32 # 14f0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	fc698993          	addi	s3,s3,-58 # 14f8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e56b8b93          	addi	s7,s7,-426 # 13f8 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e2450513          	addi	a0,a0,-476 # 13d8 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d6460613          	addi	a2,a2,-668 # 1400 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d54b0b13          	addi	s6,s6,-684 # 1420 <malloc+0x176>
  ...
  return ret;
     ...
     70a:	d0250513          	addi	a0,a0,-766 # 1408 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	ca850513          	addi	a0,a0,-856 # 1410 <malloc+0x166>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c8660613          	addi	a2,a2,-890 # 1428 <malloc+0x17e>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	c1ea0a13          	addi	s4,s4,-994 # 1430 <malloc+0x186>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bf060613          	addi	a2,a2,-1040 # 1438 <malloc+0x18e>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b5260613          	addi	a2,a2,-1198 # 1400 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b7260613          	addi	a2,a2,-1166 # 1450 <malloc+0x1a6>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b2050513          	addi	a0,a0,-1248 # 1440 <malloc+0x196>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b2850513          	addi	a0,a0,-1240 # 1458 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b5c70713          	addi	a4,a4,-1188 # 14b8 <malloc+0x20e>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a6860613          	addi	a2,a2,-1432 # 1470 <malloc+0x1c6>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a3a58593          	addi	a1,a1,-1478 # 1478 <malloc+0x1ce>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	776080e7          	jalr	1910(ra) # 11be <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	9b850513          	addi	a0,a0,-1608 # 1408 <malloc+0x15e>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	a1648493          	addi	s1,s1,-1514 # 1488 <malloc+0x1de>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a7048493          	addi	s1,s1,-1424 # 1508 <buf.1181>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a63a0a13          	addi	s4,s4,-1437 # 150b <buf.1181+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9e0a8a93          	addi	s5,s5,-1568 # 1490 <malloc+0x1e6>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	696080e7          	jalr	1686(ra) # 11be <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	9d650513          	addi	a0,a0,-1578 # 1508 <buf.1181>
...
0000000000000eba <barrier_alloc>:
...
0000000000000ed8 <buffer_cond_init>:
.global buffer_cond_init
buffer_cond_init:
 li a7, SYS_buffer_cond_init
     ed8:	02300893          	li	a7,35
 ecall
     edc:	00000073          	ecall
 ret
     ee0:	8082                	ret

0000000000000ee2 <cond_consume>:
.global cond_consume
cond_consume:
 li a7, SYS_cond_consume
     ee2:	02500893          	li	a7,37
 ecall
     ee6:	00000073          	ecall
 ret
     eea:	8082                	ret

0000000000000eec <cond_produce>:
.global cond_produce
cond_produce:
 li a7, SYS_cond_produce
     eec:	02400893          	li	a7,36
 ecall
     ef0:	00000073          	ecall
 ret
     ef4:	8082                	ret

0000000000000ef6 <buffer_sem_init>:
.global buffer_sem_init
buffer_sem_init:
 li a7, SYS_buffer_sem_init
     ef6:	02600893          	li	a7,38
 ecall
     efa:	00000073          	ecall
 ret
     efe:	8082                	ret

0000000000000f00 <sem_consume>:
.global sem_consume
sem_consume:
 li a7, SYS_sem_consume
     f00:	02800893          	li	a7,40
 ecall
     f04:	00000073          	ecall
 ret
     f08:	8082                	ret

0000000000000f0a <sem_produce>:
.global sem_produce
sem_produce:
 li a7, SYS_sem_produce
     f0a:	02700893          	li	a7,39
 ecall
     f0e:	00000073          	ecall
 ret
     f12:	8082                	ret
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f2a:	ec4080e7          	jalr	-316(ra) # dea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f5c:	58050513          	addi	a0,a0,1408 # 14d8 <digits>
     f60:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1028:	4b4b8b93          	addi	s7,s7,1204 # 14d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1168:	36c90913          	addi	s2,s2,876 # 14d0 <malloc+0x226>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1230:	2d47b783          	ld	a5,724(a5) # 1500 <freep>
    ...
    125e:	00e6ea63          	bltu	a3,a4,1272 <free+0x50>
{
  ...
  freep = p;
    ...
    12a0:	26f73223          	sd	a5,612(a4) # 1500 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12d2:	23253503          	ld	a0,562(a0) # 1500 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12fa:	20a90913          	addi	s2,s2,522 # 1500 <freep>
  if(p == (char*)-1)
    12fe:	5afd                	li	s5,-1
    1300:	a88d                	j	1372 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1302:	00000797          	auipc	a5,0x0
    1306:	26e78793          	addi	a5,a5,622 # 1570 <base>
    130a:	00000717          	auipc	a4,0x0
    130e:	1ef73b23          	sd	a5,502(a4) # 1500 <freep>
    ...
    1318:	b7e1                	j	12e0 <malloc+0x36>
      if(p->s.size == nunits)
    131a:	02e48b63          	beq	s1,a4,1350 <malloc+0xa6>
        p->s.size -= nunits;
    131e:	4137073b          	subw	a4,a4,s3
    1322:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1324:	1702                	slli	a4,a4,0x20
    1326:	9301                	srli	a4,a4,0x20
    1328:	0712                	slli	a4,a4,0x4
    132a:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    132c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1330:	00000717          	auipc	a4,0x0
    1334:	1ca73823          	sd	a0,464(a4) # 1500 <freep>
      return (void*)(p + 1);
    1338:	01078513          	addi	a0,a5,16
    ...
    1340:	74a2                	ld	s1,40(sp)
    1342:	7902                	ld	s2,32(sp)
    1344:	69e2                	ld	s3,24(sp)
    ...
    1352:	e118                	sd	a4,0(a0)
    1354:	bff1                	j	1330 <malloc+0x86>
  hp->s.size = nu;
    1356:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    135a:	0541                	addi	a0,a0,16
    135c:	00000097          	auipc	ra,0x0
    1360:	ec6080e7          	jalr	-314(ra) # 1222 <free>
  return freep;
    1364:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1368:	d971                	beqz	a0,133c <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    136a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    136c:	4798                	lw	a4,8(a5)
    136e:	fa9776e3          	bgeu	a4,s1,131a <malloc+0x70>
    if(p == freep)
    1372:	00093703          	ld	a4,0(s2)
    1376:	853e                	mv	a0,a5
    1378:	fef719e3          	bne	a4,a5,136a <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    137c:	8552                	mv	a0,s4
    137e:	00000097          	auipc	ra,0x0
    1382:	ad4080e7          	jalr	-1324(ra) # e52 <sbrk>
  if(p == (char*)-1)
    1386:	fd5518e3          	bne	a0,s5,1356 <malloc+0xac>
        return 0;
    138a:	4501                	li	a0,0
    138c:	bf45                	j	133c <malloc+0x92>
