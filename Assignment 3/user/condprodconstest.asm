...
int produce (int index, int tid)
{
   ...
   a:	b7a7a783          	lw	a5,-1158(a5) # b80 <num_items>
...
main(int argc, char *argv[])
{
  ...
  84:	aea7ac23          	sw	a0,-1288(a5) # b78 <num_cons>
  buffer_cond_init();
  88:	00000097          	auipc	ra,0x0
  8c:	56a080e7          	jalr	1386(ra) # 5f2 <buffer_cond_init>
  printf("Start time: %d\n\n", uptime());
  90:	00000097          	auipc	ra,0x0
  94:	4ec080e7          	jalr	1260(ra) # 57c <uptime>
  98:	85aa                	mv	a1,a0
  9a:	00001517          	auipc	a0,0x1
  9e:	a9650513          	addi	a0,a0,-1386 # b30 <malloc+0x16c>
  ...
  b8:	ac898993          	addi	s3,s3,-1336 # b7c <num_prods>
     if (fork() == 0) {
  ...
  d8:	aa472703          	lw	a4,-1372(a4) # b78 <num_cons>
  dc:	4785                	li	a5,1
  de:	02e7d463          	bge	a5,a4,106 <main+0xec>
  e2:	4901                	li	s2,0
  e4:	00001997          	auipc	s3,0x1
  e8:	a9498993          	addi	s3,s3,-1388 # b78 <num_cons>
     if (fork() == 0) {
 ...
 10a:	a7a7a783          	lw	a5,-1414(a5) # b80 <num_items>
 10e:	00001717          	auipc	a4,0x1
 112:	a6e72703          	lw	a4,-1426(a4) # b7c <num_prods>
 116:	02e787bb          	mulw	a5,a5,a4
 11a:	00001717          	auipc	a4,0x1
 11e:	a5e72703          	lw	a4,-1442(a4) # b78 <num_cons>
 122:	02e7c7bb          	divw	a5,a5,a4
 126:	04f05063          	blez	a5,166 <main+0x14c>
 12a:	4481                	li	s1,0
 12c:	00001a17          	auipc	s4,0x1
 130:	a54a0a13          	addi	s4,s4,-1452 # b80 <num_items>
 134:	00001997          	auipc	s3,0x1
 138:	a4898993          	addi	s3,s3,-1464 # b7c <num_prods>
 13c:	00001917          	auipc	s2,0x1
 140:	a3c90913          	addi	s2,s2,-1476 # b78 <num_cons>
 144:	00000097          	auipc	ra,0x0
 148:	4b8080e7          	jalr	1208(ra) # 5fc <cond_consume>
 ...
 16a:	a167a783          	lw	a5,-1514(a5) # b7c <num_prods>
 16e:	00001717          	auipc	a4,0x1
 172:	a0a72703          	lw	a4,-1526(a4) # b78 <num_cons>
 176:	9fb9                	addw	a5,a5,a4
 178:	4705                	li	a4,1
 17a:	02f75963          	bge	a4,a5,1ac <main+0x192>
 17e:	4481                	li	s1,0
 180:	00001997          	auipc	s3,0x1
 184:	9fc98993          	addi	s3,s3,-1540 # b7c <num_prods>
 188:	00001917          	auipc	s2,0x1
 18c:	9f090913          	addi	s2,s2,-1552 # b78 <num_cons>
 190:	4501                	li	a0,0
 ...
 1ba:	99250513          	addi	a0,a0,-1646 # b48 <malloc+0x184>
 ...
 1d4:	9b052503          	lw	a0,-1616(a0) # b80 <num_items>
 1d8:	02a05263          	blez	a0,1fc <main+0x1e2>
 1dc:	00001997          	auipc	s3,0x1
 1e0:	9a498993          	addi	s3,s3,-1628 # b80 <num_items>
   return index+(num_items*tid);
 1e4:	0325053b          	mulw	a0,a0,s2
	for (j=0; j<num_items; j++) {cond_produce(produce(j, i));}
 1e8:	9d25                	addw	a0,a0,s1
 1ea:	00000097          	auipc	ra,0x0
 1ee:	41c080e7          	jalr	1052(ra) # 606 <cond_produce>
 ...
 20a:	97a7a783          	lw	a5,-1670(a5) # b80 <num_items>
 20e:	00001717          	auipc	a4,0x1
 212:	96e72703          	lw	a4,-1682(a4) # b7c <num_prods>
 216:	02e787bb          	mulw	a5,a5,a4
 21a:	00001717          	auipc	a4,0x1
 21e:	95e72703          	lw	a4,-1698(a4) # b78 <num_cons>
 222:	02e7c7bb          	divw	a5,a5,a4
 226:	02f05f63          	blez	a5,264 <main+0x24a>
 22a:	00001a17          	auipc	s4,0x1
 22e:	956a0a13          	addi	s4,s4,-1706 # b80 <num_items>
 232:	00001997          	auipc	s3,0x1
 236:	94a98993          	addi	s3,s3,-1718 # b7c <num_prods>
 23a:	00001917          	auipc	s2,0x1
 23e:	93e90913          	addi	s2,s2,-1730 # b78 <num_cons>
 242:	00000097          	auipc	ra,0x0
 246:	3ba080e7          	jalr	954(ra) # 5fc <cond_consume>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 676:	4ee50513          	addi	a0,a0,1262 # b60 <digits>
 67a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 742:	422b8b93          	addi	s7,s7,1058 # b60 <digits>
 ...
 882:	2da90913          	addi	s2,s2,730 # b58 <malloc+0x194>
        while(*s != 0){
...
free(void *ap)
{
 ...
 94a:	2427b783          	ld	a5,578(a5) # b88 <freep>
 ...
 978:	00e6ea63          	bltu	a3,a4,98c <free+0x50>
{
 ...
 9ba:	1cf73923          	sd	a5,466(a4) # b88 <freep>
}
 9be:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9ec:	1a053503          	ld	a0,416(a0) # b88 <freep>
 ...
 a14:	17890913          	addi	s2,s2,376 # b88 <freep>
  if(p == (char*)-1)
 a18:	5afd                	li	s5,-1
 a1a:	a88d                	j	a8c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a1c:	00000797          	auipc	a5,0x0
 a20:	17478793          	addi	a5,a5,372 # b90 <base>
 a24:	00000717          	auipc	a4,0x0
 a28:	16f73223          	sd	a5,356(a4) # b88 <freep>
 a2c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a4e:	12a73f23          	sd	a0,318(a4) # b88 <freep>
      return (void*)(p + 1);
